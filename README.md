...
- The contribution heatmap fetches [`data/contributions.json`](data/contributions.json) at load time, falling back to a baked-in snapshot if that fetch fails (offline, CORS hiccup, etc).
